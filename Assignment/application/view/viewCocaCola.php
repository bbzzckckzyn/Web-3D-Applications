...
<html lang="en">
  <head>
    ...
    <title>jl2042 My Assignment</title>
      ...
      <nav id="headerColor" class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
            ...
            <div class="logo">
              <a class="navbar-brand" href="#">
                <!-- <h1> </h1> -->
                <h3>Coca-Cola Vitality is always</h3>
                <p>Life is about movement</p>
              </a>
            </div>
            ...
            <div class="row">
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="../application/assets/image/01.jpg" data-fancybox data-caption="My 3D Coke Can Render">
                            <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/image/01.png" alt="Coca Cola">
                          </a>
                          <div class="card-body">
                  ...
                  <div class="col-sm-4">
                      <div class="card">
                          <a href="../application/assets/image/04.jpg" data-fancybox data-caption="My 3D Sprite Bottle Render" class="img-narrow">
                            <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/image/02.png" alt="Sprite">
                          </a>
                          <div class="card-body">
                  ...
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="../application/assets/image/03.jpg" data-fancybox data-caption="My 3D Pepper Cup Render" class="thumbnail">
                            <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/image/03.png" alt="Dr Pepper">
                          </a>
                          <div class="card-body">
                            ...
                            <a href="https://www.redbull.com/cn-zh/energydrink/gongsi" class="btn btn-primary btn-responsive">Find out more ...</a>
                          </div>
                      </div>
                  </div>
            </div>
                ...
                <div class="card text-left">
                  ...
                  <div class="card-body">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-success btn-responsive" onMouseUp="cokeScene(); cokeDescription();">Tin can</button>
                        <button type="button" class="btn btn-success btn-responsive" onMouseUp="spriteScene(); spriteDescription();">Glass bottle</button>
                        <button type="button" class="btn btn-success btn-responsive" onMouseUP="pepperScene(); pepperDescription();">Glass</button>
                          ...
                          <x3d id="wire">
                            <scene>
                                <Switch whichChoice="0" id='SceneSwitch'>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../application/assets/x3d/drink1.x3d" > </inline>
                                    </transform>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../application/assets/x3d/.x3d"> </inline>
                                    </transform>
                                    <transform>
      ...
      <nav id="footerColor" class="navbar navbar-expand-sm footer">
          <div class="container-fluid">   
              <div class="navbar-text float-left copyright">
                  <p><span class="align-baseline">&copy My Assignment 2023 | <a href="javascript:changeLook()">Restyle</a> | <a href="javascript:changeBack()">Reset</a></span></p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Jianfu Li，Email：jl2042@sussex.ac.uk</p>
                </div>
